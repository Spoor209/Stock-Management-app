...
public class GenericDaoImpl<E> implements IGenericDao<E> {
	...
	//Access to the connect DB with bean EntityManagerFactory
	...
	//Get the type for the Class that extend a generic type and print actual type on which it was parameterized 
