		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-4 text-gray-800"><fmt:message code="article.titre"/></h1>
             ...
             <c:url value="/article/enregistrer" var="urlEnregistrer"/>
              <f:form modelAttribute="article" action="${urlEnregistrer }" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group">
                  ...
                  <f:input path="codeArticle"  class="form-control" placeholder="Entrez le code de l'article"/>
               </div>
               <div class="form-group">
                  <label><fmt:message code="common.designation.article"/></label>
                  <f:input path="designation" class="form-control" placeholder="Entrez la désignation de l'article"/>
               </div>
               <div class="form-group">
                  <label><fmt:message code="common.prixunitaire.ht"/></label>
                  <f:input path="prixUnitaireHT" id="prixUnitHT" class="form-control" placeholder="Entrez le prix unitaire hors taxe"/>
               </div>
               <div class="form-group">
                  <label><fmt:message code="common.tauxtva"/></label>
                  <f:input path="tauxTVA" id= "tauxTva" class="form-control" placeholder="Entrez la TVA"/>
               </div>
               <div class="form-group">
                  <label><fmt:message code="common.prixunitaire.ttc"/></label>
                  <f:input path="prixUnitaireTTC" id = "prixUnitTTC" class="form-control" placeholder="Entrez le prix unitaire TTC"/>
               </div>
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="panel-footer">
                     ...
                     <a href="<c:url value="/article/" />" class="btn btn-danger btn-icon-split">
