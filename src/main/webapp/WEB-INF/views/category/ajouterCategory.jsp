		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-4 text-gray-800"><fmt:message code="category.titre"/></h1>
            ...
            <div class="card-body">
             <c:url value="/category/enregistrer" var="urlEnregistrer"/>
              <f:form modelAttribute="category" action="${urlEnregistrer }" enctype="multipart/form-data" role="form">
                <f:hidden path="idCategory"/>
			    
              
                <div class="form-group">
                  <label><fmt:message code="common.code"/></label>
                  <f:input path="code" type="text" class="form-control" placeholder="Entrez le code"/>
               </div>
               <div class="form-group">
                  <label><fmt:message code="common.designation"/></label>
                  <f:input path="designation" type="text" class="form-control" placeholder="Entrez la désignation"/>
               </div>
                  ...
                  <div class="panel-footer">
                     ...
                     <a href="<c:url value="/category/" />" class="btn btn-danger btn-icon-split">
