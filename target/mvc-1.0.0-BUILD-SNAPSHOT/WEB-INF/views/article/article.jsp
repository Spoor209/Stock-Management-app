...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800"><fmt:message code="common.articles"/></h1>
          <nav aria-label="breadcrumb">
          
          <ol class="breadcrumb">
           <li class="breadcrumb-item">
             <a href="<c:url value="/article/nouveau"/>"class="btn btn-success btn-icon-split">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary"><fmt:message code="article.list"/></h6>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable">
                  <thead>
                    <tr>
                      ...
                      <th><fmt:message code="common.code.article"/></th>
                      <th><fmt:message code="common.designation.article"/></th>
                      <th><fmt:message code="common.prixunitaire.ht"/></th>
                  ...
                  <tbody>
                    ...
                    <tr class="odd gradeX">
                      <td class="center"><img src="${article.getPhoto() }" width="90px" height="90px"/></td>
                      ...
                      <td>
                       ...
                       <a href="javascript:void(0);" data-toggle="modal" data-target="#modalArticle${article.getIdArticle() }"class="btn btn-danger btn-circle btn-sm">
