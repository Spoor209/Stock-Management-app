...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800"><fmt:message code="common.client"/></h1>
          <nav aria-label="breadcrumb">
          
          <ol class="breadcrumb">
           <li class="breadcrumb-item">
             <a href="<c:url value="/client/nouveau"/>"class="btn btn-success btn-icon-split">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary"><fmt:message code="client.list"/></h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="center"><img src="${client.getPhoto() }" width="90px" height="90px"/></td>
                      <td>${client.getNom() }</td>
                      ...
                      <td>
                       ...
                       <a href="javascript:void(0);" data-toggle="modal" data-target="#modalClient${client.getIdClient() }"class="btn btn-danger btn-circle btn-sm">
                             ...
                             <div class="modal-content">
                                ...
                                <span aria-hidden="true">&times;</span>
                                 ...
                                 <div class="modal-body">
                                   <fmt:message code="common.suppr.question" />
                                 </div>
