...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800"><fmt:message code="common.categorie"/></h1>
          <nav aria-label="breadcrumb">
          
          <ol class="breadcrumb">
           <li class="breadcrumb-item">
             <a href="<c:url value="/category/nouveau"/>"class="btn btn-success btn-icon-split">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary"><fmt:message code="category.list"/></h6>
            </div>
            <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <tr class="odd gradeX">
                      ...
                      <td>
                         ...
                         <c:url value="/category/modifier/${cat.getIdCategory() }" var="urlModifier" />
                        <a href="${urlModifier }" class="btn btn-warning btn-circle btn-sm">
                       <i class="fas fa-edit">
                       </i></a>
                       <a href="javascript:void(0);" data-toggle="modal" data-target="#modalCategory${cat.getIdCategory() }"class="btn btn-danger btn-circle btn-sm">
                       <i class="fas fa-trash">
                       </i></a>
                       <div class="modal fade" id="modalCategory${cat.getIdCategory() }" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                             ...
                             <div class="modal-content">
                                ...
                                <span aria-hidden="true">&times;</span>
                                 ...
                                 <div class="modal-body">
                                   <fmt:message code="common.suppr.category" />
                                 </div>
